...
- [ ] Execute comparison batch 2 after review: separate raw and encoded-Z Ricci, then compare visible chi/metric/K/Theta/A RHS families at identical analytic jets in stock `d=3`. Do not treat those coefficients as target-`d=4` evidence.
