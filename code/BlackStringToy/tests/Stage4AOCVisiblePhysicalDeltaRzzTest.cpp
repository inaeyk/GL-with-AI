...
void check_scope_flags_and_validation()
{
    ...
    require_true("visible Rzz helper does not implement delta R_xx",
                 !Visible::visible_delta_rxx_implemented);
    require_true("visible Rzz helper does not perform A curvature insertion",
                 !Visible::trace_free_a_curvature_source_implemented);
    require_true("visible Rzz helper does not perform Theta Ricci insertion",
