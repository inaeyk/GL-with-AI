...
// Stage 2A scaffold note: this executable is a minimally renamed copy of the
// public GRChombo BinaryBH example. It is not physical black-string evolution.
...
int runGRChombo(int argc, char *argv[])
{
    ...
    DefaultLevelFactory<BlackStringToyLevel> black_string_toy_level_fact(
        bh_amr, sim_params);
    setupAMRObject(bh_amr, black_string_toy_level_fact);
