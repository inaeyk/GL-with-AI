...
\title{Stage 3G Physics Note: Conformal Cartoon Translation}
...
Stage 3G translates the diagonal reduced cartoon geometry from physical metric
...
The initial Stage 3G repository script checked the \(q=h_{ww}/\chi\)
