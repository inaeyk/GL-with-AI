...
be even. These component parities should be aligned with the chosen
GRChombo-facing project conventions before coding.
...
and full contracted-connection convention still need to be derived and
documented in the GRChombo-facing cartoon extension.
