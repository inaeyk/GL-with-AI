...
\begin{itemize}
  ...
  \item Nonlinear source blocks require comparison against Pau's implementation
...
GL dynamics require reference-code comparison and convergence evidence.

\section{Non-Goals And Next Stages}

Stage 3H does not solve small-\(x\) regularity, decide final gauge choices,
replace comparison with Pau's implementation, or start implementation. Stage 3I
